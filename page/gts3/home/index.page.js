...
//var Is_start=false  1打开删除的条目闪烁问题 2滑动? 3常亮问题 4设置界面显示问题 5自动打开失效的问题
Page({
  build() {
...
//  hmUI.updateStatusBarTitle("欢迎使用")

    hmUI.setScrollView(true, 450, 1) 
  
    // data=readFileSync('txtdata')
  ...
  item_config: [
    {
      type_id: 0,
      item_bg_radius: 10,
      text_view:[{ x: 0, y: 0, w: 390-72, h: 70,key: 'name', color: 0xc0dfd7, text_size: 30 }],
      text_view_count: 1,
      item_height: 75
    },
    {
      ...
      item_bg_radius: 36,
      text_view:[{ x: 0, y: 0, w: 390-72, h: 70,key: 'name', color: 0xffffff, text_size: 44 }],
      text_view_count: 1,
      item_height: 75
    },
    {
      ...
      item_bg_radius: 0,
      text_view:[{ x: 0, y: 0, w: 390-72, h: 0,key: 'name', color: 0xffffff, text_size: 0 }],
      text_view_count: 1,
      item_height: 0
    }
  ],
...
// if(sb==0){
//   writeFileSync(text, false,'txtdata')
// }


text.unshift(gettext('setting'))
// text.push(gettext('save'))
// text_type_config.push({
//   start: txtNum+1,
//   end: txtNum+1,
//   type_id: 1
...
scrollList.setProperty(hmUI.prop.UPDATE_DATA, {
  ...
  hmApp.gotoPage({ file: 'page/gts3/home/sos' })
    ...
    hmApp.gotoPage({ file: 'page/gts3/home/changetime' })
