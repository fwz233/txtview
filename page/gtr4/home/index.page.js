...
Page({
      ...
      item_config: [
        {
          type_id: 0,
          item_bg_radius: 10,
          text_view: [{ x: 0, y: 0, w: 466 - 144, h: 70, key: 'name', color: 0xc0dfd7, text_size: 30 }],
          text_view_count: 1,
          item_height: 75
        },
        {
          ...
          item_bg_radius: 36,
          text_view: [{ x: 0, y: 0, w: 466 - 144, h: 70, key: 'name', color: 0xffffff, text_size: 44 }],
          text_view_count: 1,
          item_height: 75
        },
        {
          ...
          item_bg_radius: 0,
          text_view: [{ x: 0, y: 0, w: 466 - 144, h: 0, key: 'name', color: 0xffffff, text_size: 0 }],
          text_view_count: 1,
          item_height: 0
        }
      ],
  ...
  onDestory() {
    ...
    if (index != 0 && index != txtNum + 1) {
      ...
      hmApp.gotoPage({ file: 'page/gtr4/home/changetime' })
